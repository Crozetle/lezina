...
class Car {
    ...
    // При достижении позиции WRAP_POINT автомобиль появляется заново слева.
    // Это совпадает с позицией светофора, поэтому машина не «проезжает сквозь» знак.
    static final int WRAP_POINT = 57;
